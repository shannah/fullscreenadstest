 ...
 * @author Shai Almog
 */
public class FullscreenAdsTestStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "FullscreenAdsTest";
    ...
    private FullscreenAdsTest mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new FullscreenAdsTestStub());
    }
